...
layout: page
title: People
share-title: People | THREADS Lab (Naser Ezzati-Jivan)
share-description: The people of THREADS Lab at Brock University — principal investigator, PhD and MSc students, undergraduate researchers, research assistants, interns, and alumni.
keywords: "THREADS Lab team, Naser Ezzati-Jivan, Brock University, PhD students, MSc students, research assistants, Mitacs Globalink interns, research group members, alumni"
---
...
<div class="team-grid" markdown="0">
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">AJ</div>
    <div class="member-body">
      <p class="member-name">Afrin Jubaida</p>
      <p class="member-role">Brock University<br>Research area: <em>EDI-by-Design in the Age of AI</em></p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">HA</div>
    <div class="member-body">
      <p class="member-name">Haitham Al Satai</p>
      <p class="member-role">Polytechnique Montréal · since Jan 2026<br><em>Adaptive Tracing for Efficient Performance Diagnosis in Distributed Systems</em><br>Co-supervised with Dr. Foutse Khomh</p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">FB</div>
    <div class="member-body">
      <p class="member-name">François Philippe Ossim Belias</p>
      <p class="member-role">Polytechnique Montréal · since Jan 2025<br><em>Efficient Training of LLMs</em><br>Co-supervised with Dr. Foutse Khomh</p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">NI</div>
    <div class="member-body">
      <p class="member-name">Nurbek Imangazin</p>
      <p class="member-role">Brock University · since Sep 2024<br>Co-supervised with Dr. Michael Winter</p>
    </div>
  </div>
</div>
...
<div class="team-grid" markdown="0">
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">YS</div>
    <div class="member-body">
      <p class="member-name">Yuvraj Sehgal</p>
      <p class="member-role">since Sep 2025<br><em>Generating Syntactic Data using Diffusion Models</em></p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">SP</div>
    <div class="member-body">
      <p class="member-name">Sneh Patel</p>
...
<div class="team-grid" markdown="0">
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">JW</div>
    <div class="member-body">
      <p class="member-name">James Windjack</p>
      <p class="member-role">4F90 project · since Sep 2025</p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">AS</div>
    <div class="member-body">
      <p class="member-name">Ansh Shah</p>
      <p class="member-role">4F90 project · since Sep 2025</p>
    </div>
  </div>
</div>
...
<div class="team-grid" markdown="0">
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">FA</div>
    <div class="member-body">
      <p class="member-name">Flora Nah Asah</p>
      <p class="member-role">EDI-by-Design in the Age of AI · since Feb 2026</p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">MJ</div>
    <div class="member-body">
      <p class="member-name">Mahsa Jafaie Menarbazari</p>
      <p class="member-role">EDI-by-Design in the Age of AI · since Feb 2026</p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">AD</div>
    <div class="member-body">
      <p class="member-name">Abhijeet Dhali</p>
      <p class="member-role">EDI-by-Design in the Age of AI and the Mitacs project with JOE · since Feb 2026</p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">BK</div>
    <div class="member-body">
      <p class="member-name">Becky Kwok</p>
      <p class="member-role">Mitacs project with JOE · since Feb 2026</p>
    </div>
  </div>
</div>
...
<div class="team-grid" markdown="0">
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">EC</div>
    <div class="member-body">
      <p class="member-name">Eman Chaudhary</p>
      <p class="member-role">Aug 10 - Oct 23, 2026<br><em>Harnessing Large Language Models for Automated Software Log Understanding</em></p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">KG</div>
    <div class="member-body">
      <p class="member-name">Khaled Gardabbou</p>
      <p class="member-role">Jul 6 - Sep 25, 2026<br><em>Intelligent Software Agents for Autonomous Monitoring and Repair</em></p>
    </div>
  </div>
  <div class="member-card">
    <div class="member-avatar" aria-hidden="true">MH</div>
    <div class="member-body">
      <p class="member-name">Muhammad Maaz Hamid</p>
      <p class="member-role">Aug 7 - Oct 30, 2026<br><em>Intelligent Software Agents for Autonomous Monitoring and Repair</em></p>
    </div>
  </div>
</div>
...
Former graduate students, postdoctoral researchers, research associates, and undergraduate researchers. Roles reflect the position held while at THREADS Lab; paper authorship should be checked in the [publication catalog]({{ site.baseurl }}/research-publications/).

<div class="team-grid" markdown="0">
  <div class="member-card is-alum">
    <div class="member-avatar" aria-hidden="true">AH</div>
    <div class="member-body">
      <p class="member-name">Amir Haghshenas</p>
  ...
  <div class="member-card is-alum">
    <div class="member-avatar" aria-hidden="true">MJ</div>
    <div class="member-body">
      <p class="member-name">Madeline Janecek</p>
      <p class="member-role">MSc</p>
    </div>
  </div>
  <div class="member-card is-alum">
    <div class="member-avatar" aria-hidden="true">TZ</div>
    <div class="member-body">
      <p class="member-name">Tong Zhang</p>
      <p class="member-role">MSc</p>
    </div>
  </div>
  <div class="member-card is-alum">
  ...
  <div class="member-card is-alum">
    <div class="member-avatar" aria-hidden="true">YG</div>
    <div class="member-body">
      <p class="member-name">Yue Guan</p>
      <p class="member-role">MSc</p>
    </div>
  </div>
  <div class="member-card is-alum">
    ...
    <div class="member-body">
      <p class="member-name"><a href="https://www.linkedin.com/in/morteza-noferesti-a69862188/">Morteza Noferesti</a></p>
      <p class="member-role">Postdoctoral Researcher</p>
    </div>
  </div>
  <div class="member-card is-alum">
    <div class="member-avatar" aria-hidden="true">KD</div>
    <div class="member-body">
      <p class="member-name">Kasra Darvishi</p>
      <p class="member-role">Research Associate</p>
    </div>
  </div>
  <div class="member-card is-alum">
    <div class="member-avatar" aria-hidden="true">RB</div>
    <div class="member-body">
      <p class="member-name"><a href="https://www.linkedin.com/in/raghav-bhardwaj-878067153/">Raghav Bhardwaj</a></p>
