...
International students may also be eligible for the [Mitacs Globalink Research Internship](https://www.mitacs.ca/our-programs/globalink-research-internship-students/) program, which is currently funding three interns in the lab.
...
**Profiles and publications:** [Research]({{ site.baseurl }}/tabs/research/) · [Team]({{ site.baseurl }}/tabs/team/) · [Google Scholar](https://scholar.google.com/citations?user=sJWcLv8AAAAJ) · [ORCID](https://orcid.org/0000-0003-1435-6297) · [Publication catalog]({{ site.baseurl }}/research-publications/)
