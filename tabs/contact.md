...
2. **Why THREADS Lab** — which of our [research directions]({{ site.baseurl }}/tabs/research/) interests you, and *why* that problem interests you. Referring to a specific paper from our [publication catalog]({{ site.baseurl }}/tabs/publications/) is the clearest way to show this.
...
[nezzati@brocku.ca](mailto:nezzati@brocku.ca)
...
**Profiles and publications:** [Research]({{ site.baseurl }}/tabs/research/) · [People]({{ site.baseurl }}/tabs/people/) · [Publications]({{ site.baseurl }}/tabs/publications/) · [Google Scholar](https://scholar.google.ca/citations?hl=en&user=sJWcLv8AAAAJ&view_op=list_works&sortby=pubdate) · [ORCID](https://orcid.org/0000-0003-1435-6297) · [LinkedIn](https://www.linkedin.com/in/naser-ezzati-jivan-71418724)
