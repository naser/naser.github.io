...
*We look for:* a completed (or nearly completed) PhD in computer science, software engineering, or a related field; a strong publication record in software engineering, systems, or applied machine learning; and depth in one or more of tracing and observability, performance analysis, distributed systems, or LLM-based software analysis.
...
*We look for:* a BSc in computer science or a related field, solid programming ability (Python, C/C++, or Java), and genuine curiosity about how systems behave under load and failure.
...
*We look for:* fourth-year standing, a clear interest in a specific research direction, and the ability to commit to a year-long project.
...
We welcome collaboration on problems such as:

- **Software observability and tracing** — adaptive and multilevel tracing, reducing telemetry cost without losing diagnostic value, kernel and distributed tracing in production.
- **Performance engineering and reliability** — latency and root-cause analysis, performance regressions, anti-pattern detection, and diagnosing intermittent failures in distributed systems.
- **AI, LLMs, and agentic systems** — observability, auditing, and runtime governance for AI-driven systems, LLM-assisted log and trace analysis, and evaluating agent behaviour with execution evidence.
- **Physical and embodied AI** — observability and energy-usage analysis for robots, drones, and other embodied platforms, and benchmarking AI inference on heterogeneous hardware.

Collaboration can take several forms: a funded intern or student embedded on a problem, a joint grant application, a focused evaluation of an existing system, or an exploratory conversation about a problem you cannot currently diagnose. Mitacs programs in particular make it straightforward to fund a student to work on a company problem with matched contributions.
...
3. **Attach your CV** and transcripts if you have them.
4. **Apply formally** through Brock graduate admissions if you are applying for a PhD or MSc.
5. **Interview.** Promising applicants are invited for a conversation about fit and possible projects.
...
- **Scholarship support** — we help students apply for NSERC, OGS, and Brock internal awards.
...
Yes. The lab has hosted international interns and co-supervises students at other institutions. Graduate applicants should check Brock's admission and study-permit requirements.

**I emailed and did not hear back. Should I follow up?**\
A short follow-up after two weeks is fine. Messages that are clearly mass-sent, or that do not mention a specific research direction, usually do not receive a reply.

**Can I work remotely?**\
Graduate students are expected to be on campus. Some intern and collaborator arrangements can be partly remote, depending on the project.

**What should I be able to do before starting?**\
Comfortable programming, comfortable on Linux, and willing to read papers carefully. Everything else can be learned in the lab.
